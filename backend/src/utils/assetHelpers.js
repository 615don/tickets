 ...
 *
 * @param {Date|string} inServiceDate - The date the asset was put into service
 * @returns {number} Age in whole years (rounded down), minimum 0
 *
 * @example
 ...
 */
function calculateAssetAge(inServiceDate) {
  if (!inServiceDate) {
    return 0;
  }
