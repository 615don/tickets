...
#### Medium Priority (Can defer to later)
...
**Note to Dev:** Please update File List section to include `outlook-addin/src/index.css` (modified during QA review).
