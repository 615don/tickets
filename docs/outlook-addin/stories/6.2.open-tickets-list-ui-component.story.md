...
- [ ] **Task 5: Manual Testing** (AC: 1, 2, 3, 4, 5)
  - [ ] Start backend server: `npm start` from backend directory
  - [ ] Start Outlook add-in dev server: `npm run dev` from outlook-addin directory
  - [ ] Open Outlook web or desktop and sideload add-in
  - [ ] **Test Case 1: Contact with Open Tickets**
  ...
  - [ ] **Test Case 2: Ticket Selection Visual Feedback**
  ...
  - [ ] **Test Case 3: Contact with No Open Tickets**
  ...
  - [ ] **Test Case 4: Domain Match or No Match**
  ...
  - [ ] **Test Case 5: Email Selection Change**
...
- [ ] **Task 6: Verify Backward Compatibility** (AC: Epic Compatibility Requirements)
  - [ ] Verify existing ticket creation workflow still works (Story 5.4)
  - [ ] Select email from contact without open tickets
  - [ ] Fill out form and submit ticket
  - [ ] Verify ticket creation succeeds (no regression)
  - [ ] Verify TicketForm rendering without OpenTicketsList (when contact is not matched)
  - [ ] Run existing TicketForm tests if any exist (currently none - manual testing sufficient)
...
- Story is ready for manual testing (Tasks 5-6)
